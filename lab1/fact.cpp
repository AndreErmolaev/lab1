...
void Factory::show() const
{
	...
	if (count_workers)
	{
		...
		cout << std::setw(155) << "-\n";
		cout.fill(' ');
		cout << std::setw(60) << "РАБОТНИКИ " << std::endl;
		cout.fill('-');
		cout << std::setw(155) << "-\n";
		cout.fill(' ');
		cout << "|  " << std::setw(10) << "Фамилия" << "   ";
		cout << "  " << std::setw(10) << "Имя" << "   ";
		cout << "  " << std::setw(10) << "Отчество" << "   ";
		cout << "  " << std::setw(13) << "Телефон" << "   ";
		cout << "  " << std::setw(40) << "Адрес" << "   ";
		cout << "  " << std::setw(15) << "Пост" << "   ";
		cout << "  " << std::setw(10) << "Зарплата" << "   " << std::endl;
		cout.fill('-');
		cout << std::setw(155) << "-\n";
		cout.fill(' ');
	...
	if (count_furnitures)
	{
		...
		cout << std::setw(155) << "_\n";
		cout.fill(' ');
		cout << std::setw(60) << "МЕБЕЛЬ " << std::endl;
		cout.fill('-');
		cout << std::setw(155) << "-\n";
		cout.fill(' ');
		cout << "|  " << std::setw(20) << "Тип" << "   ";
		cout << "  " << std::setw(20) << "Материал" << "   ";
		cout << "  " << std::setw(20) << "Цвет" << "   ";
		cout << "  " << std::setw(6) << "Высота" << "   ";
		cout << "  " << std::setw(6) << "Ширина" << "   ";
		cout << "  " << std::setw(6) << "Глубина" << "   ";
		cout << "  " << std::setw(11) << "Стоимость" << "   " << std::endl;
		cout.fill('-');
		cout << std::setw(155) << "-\n";
		cout.fill(' ');
	...
	if (count_machines)
	{
		...
		cout << std::setw(155) << "_\n";
		cout.fill(' ');
		cout << std::setw(60) << "МАШИНЫ " << std::endl;
		cout.fill('-');
		cout << std::setw(155) << "-\n";
		cout.fill(' ');
		cout << "|  " << std::setw(20) << "Марка" << "   ";
		cout << "  " << std::setw(20) << "Модель" << "   ";
		cout << "  " << std::setw(20) << "Номер" << "   ";
		cout << "  " << std::setw(6) << "Цена" << "   " << std::endl;
		cout.fill('-');
		cout << std::setw(155) << "-\n";
		cout.fill(' ');
